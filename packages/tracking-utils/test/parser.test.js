...
describe('parseTrackingEvent', () => {
    it('should parse a standard tracking event', () => {
        const event = (0, parser_1.parseTrackingEvent)({
            date: '2026-03-10',
            time: '14:30',
            location: 'Austin, TX',
            status_code: 'PU',
...
describe('parseTrackingResponse', () => {
    it('should parse a full tracking response', () => {
        const info = (0, parser_1.parseTrackingResponse)('1Z999AA10123456784', 'ups', [
    ...
    it('should sort events by timestamp descending', () => {
        const info = (0, parser_1.parseTrackingResponse)('TEST123', 'fedex', [
